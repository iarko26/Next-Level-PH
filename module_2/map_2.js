...
const Top3ProductName=rawApiData.filter((val)=>val.category==="Electronics").sort((a,b)=>b.rating-a.rating).slice(0,3).map((key)=>({name:key.productName}));
console.log(Top3ProductName);
